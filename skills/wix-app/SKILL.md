...
4. For an accepted custom WDS or hybrid implementation, run `node "$HOME/.agents/skills/wix-app/scripts/audit-dashboard-code.mjs" <dashboard-source-directory>`. Standard generated Auto Patterns pages do not require this custom-route audit.
